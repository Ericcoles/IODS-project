...
After adding more variables to the model, the prediction error rose to over 31%. This leads me to believe that not enough variables were used to have a significant change.
